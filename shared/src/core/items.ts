...
export const ITEMS: Record<string, ItemDefinition> = {
  ...
  "broadsword": {
    ...
    abilities: [{
      ...
      visual: { color: 0xb0b0b0, trailEffect: "slash", screenShake: 0.25 },
    } satisfies AttackAbility],
    animSet: "two-handed",
  },
  "battle-axe": {
    ...
    abilities: [{
      ...
      damage: 22,
      visual: { color: 0x8a7050, trailEffect: "slash", screenShake: 0.25 },
    } satisfies AttackAbility],
    animSet: "two-handed",
  },
  "mace": {
    ...
    abilities: [{
      ...
      damage: 15,
      onHit: [{ type: "knockback", distance: 35 }],
      visual: { color: 0x707070, trailEffect: "slash", screenShake: 0.3 },
    } satisfies AttackAbility],
    animSet: "sword",
  },
