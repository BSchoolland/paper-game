/**
 * agent-06's hero entry. Replace `hero` below with your own `HeroController` (see hero-arena/README.md).
 ...
 *   bun hero-arena/src/harness.ts agent-06 agent-06       # mirror — fight yourself (self-play)
 *   bun hero-arena/src/harness.ts agent-06 agent-01 42    # head to head on seed 42
