...
const GEMWARDEN_PRISM_STORM: AttackAbility = {
  ...
  kind: "attack",
  cost: { red: 2 },
  shape: { kind: ShapeKind.Circle, radius: 85, range: 140 },
  damage: 26,
  knockback: 0,
...
const GROTTO_TITAN_CRYSTAL_BURST: AttackAbility = {
  ...
  kind: "attack",
  cost: { red: 1 },
  shape: { kind: ShapeKind.Circle, radius: 110, range: 0 },
  damage: 18,
  knockback: 50,
  visual: { color: 0xe760c9, trailEffect: "explosion", screenShake: 0.6 },
};
...
const THE_MYCELIUM_SPORE_NOVA: AttackAbility = {
  ...
  kind: "attack",
  cost: { red: 1 },
  shape: { kind: ShapeKind.Circle, radius: 110, range: 170 },
  damage: 22,
  knockback: 40,
  visual: { color: 0x9b5de5, trailEffect: "splash", screenShake: 0.4 },
};
...
const ENEMY_TEMPLATES: Record<string, UnitTemplate> = {
  ...
  "crystal-weaver": {
    abilities: [makeMove(140), CRYSTAL_WEAVER_RESONANCE_FIELD, CRYSTAL_WEAVER_FANG_STRIKE],
    hp: 100,
    energy: { red: 2, blue: 2 },
    collisionRadius: 18,
  ...
  "the-gemwarden": {
    abilities: [makeMove(55), GEMWARDEN_PRISM_STORM, GEMWARDEN_CRYSTAL_BOLT],
    hp: 185,
    energy: { red: 2, blue: 1 },
    collisionRadius: 18,
  ...
  "grotto-titan": {
    abilities: [makeMove(65), GROTTO_TITAN_GEODE_SLAM, GROTTO_TITAN_CRYSTAL_BURST, GROTTO_TITAN_PRISM_HORN],
    hp: 360,
    energy: { red: 3, blue: 1 },
    collisionRadius: 28,
...
const DIMENSION_2_ITEMS: Record<string, ItemDefinition> = {
  "crystal-shard-blade": {
    ...
    abilities: [{
      ...
      kind: "attack",
      cost: { red: 1 },
      shape: { kind: ShapeKind.Rectangle, length: 80, width: 12 },
      damage: 16,
      knockback: 0,
  ...
  "fungal-mace": {
    ...
    abilities: [{
      ...
      kind: "attack",
      cost: { red: 1 },
      shape: { kind: ShapeKind.Rectangle, length: 80, width: 14 },
      damage: 18,
      knockback: 0,
      visual: { color: 0x9b5de5, trailEffect: "thrust", screenShake: 0.2 },
    } satisfies AttackAbility],
  ...
  "geode-knuckles": {
    ...
    abilities: [{
      ...
      kind: "attack",
      cost: { red: 1 },
      shape: { kind: ShapeKind.Rectangle, length: 85, width: 14 },
      damage: 20,
      knockback: 0,
      visual: { color: 0x9b5de5, trailEffect: "thrust", screenShake: 0.2 },
    } satisfies AttackAbility],
