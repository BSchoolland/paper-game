...
// Mechanical identity: pulls, slow. Less knockback than dim 0.
// =============================================================================
...
const ENEMY_TEMPLATES: Record<string, UnitTemplate> = {
  ...
  "abyssal-angler": {
    abilities: [makeMove(110), ABYSSAL_ANGLER_LURE_DRAG, ABYSSAL_ANGLER_BITE],
    hp: 200,
    energy: { red: 2, blue: 2 },
    collisionRadius: 20,
...
const DIMENSION_1_ITEMS: Record<string, ItemDefinition> = {
  ...
  "coral-blade": {
    ...
    abilities: [{
      ...
      damage: 16,
      knockback: 0,
      onHit: [{ type: "applyStatus", status: "suppressed", duration: 2, value: 2 }],
  ...
  "barbed-harpoon": {
    ...
    abilities: [{
      ...
      kind: "attack",
      cost: { red: 2 },
      shape: { kind: ShapeKind.Rectangle, length: 130, width: 26 },
      damage: 35,
      knockback: 0,
      onHit: [{ type: "pull", distance: 50 }],
  ...
  "urchin-flail": {
    ...
    abilities: [{
      ...
      damage: 22,
      knockback: 0,
      onHit: [{ type: "applyStatus", status: "slowed", duration: 2, value: 0.6 }],
  ...
  "crab-claw-gauntlet": {
    ...
    abilities: [{
      ...
      damage: 20,
      knockback: 0,
      onHit: [{ type: "applyStatus", status: "rooted", duration: 3, value: 1 }],
      visual: { color: 0xb87333, trailEffect: "slash", screenShake: 0.2 },
    } satisfies AttackAbility, {
      ...
      kind: "attack",
      cost: { red: 1 },
      shape: { kind: ShapeKind.Rectangle, length: 90, width: 22 },
      damage: 28,
      knockback: 0,
